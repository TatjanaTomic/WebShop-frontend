...
export class MyPurchasesComponent implements OnInit {
  ...
  constructor(private purchasesService: PurchasesService, private categoriesService: CategoriesService, private toast: ToastrService, private authService: AuthService) {}
