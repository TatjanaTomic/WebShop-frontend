...
export class ProfileComponent implements OnInit {
  ...
  constructor(private usersService: UsersService, private toast: ToastrService, private authService: AuthService, private formBuilder: FormBuilder, private router: Router) { }
